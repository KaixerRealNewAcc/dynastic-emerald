...
#define SINGLES_GIMMICK_TRIGGER_POS_X_PRIORITY (32)
#define SINGLES_GIMMICK_TRIGGER_POS_X_SLIDE (18)
#define SINGLES_GIMMICK_TRIGGER_POS_Y_DIFF (-10)

#define DOUBLES_GIMMICK_TRIGGER_POS_X_OPTIMAL (31)
#define DOUBLES_GIMMICK_TRIGGER_POS_X_PRIORITY (33)
#define DOUBLES_GIMMICK_TRIGGER_POS_X_SLIDE (18)
