...
static const u8 sDoorAnimTiles_RLittleroot[] = INCBIN_U8("graphics/door_anims/revamped/littleroot/tiles.4bpp");
static const u16 sDoorNullPalette50[] = INCBIN_U8("graphics/door_anims/revamped/littleroot/palette.pal");
...
static const u8 sDoorAnimPalettes_RLittleroot[] = {4, 3, 3, 3, 3, 3, 3, 3};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Littleroot_Littleroot_Door,                   DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_RLittleroot, sDoorAnimPalettes_RLittleroot},
