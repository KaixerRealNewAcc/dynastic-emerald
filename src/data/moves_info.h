...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_TORCH_SONG] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FIRE, //KAIDO: Maybe change too TYPE_SOUND? Dunno.
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_ECHO_BLADE] =
    {
        .name = COMPOUND_STRING("Echo Blade"),
        .description = COMPOUND_STRING(
            "An attack that attacks\n"
            "with sound in the form\n"
            "of a blade."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_SOUND,
