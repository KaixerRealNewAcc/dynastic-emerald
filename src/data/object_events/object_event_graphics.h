...
const u16 gObjectEventPal_Ritchie[] = INCBIN_U16("graphics/object_events/palettes/ritchie.gbapal");
...
const u32 gObjectEventPic_Ritchie[] = INCBIN_U32("graphics/object_events/pics/people/ritchie.4bpp");
