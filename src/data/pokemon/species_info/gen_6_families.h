...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_CHESPIN] =
    {
        ...
        .abilities = { ABILITY_BULLETPROOF, ABILITY_NONE, ABILITY_SPIKY_THORNS },
    ...
    [SPECIES_FROAKIE] =
    {
        ...
        .abilities = { ABILITY_LONG_REACH, ABILITY_NONE, ABILITY_PROTEAN },
    ...
    [SPECIES_GRENINJA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SKILL_LINK, ABILITY_BATTLE_BOND, ABILITY_PROTEAN },
        .innateAbility = ABILITY_TORRENT,
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_FLETCHLING] =
    {
        ...
        .abilities = { ABILITY_FLOCK, ABILITY_NONE, ABILITY_GALE_WINGS },
        .innateAbility = ABILITY_RIVALRY,
        .bodyColor = BODY_COLOR_RED,
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .baseSpAttack  = 73,
        .baseSpDefense = 54,
        .types = MON_TYPES(TYPE_FIRE, TYPE_SOUND),
        .catchRate = 220,
        .expYield = 74,
        .evYield_SpAttack = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RIVALRY, ABILITY_UNNERVE, ABILITY_DEFIANT },
    ...
    [SPECIES_PYROAR] =
    {
        ...
        .innateAbility = ABILITY_COMPETITIVE,
        .bodyColor = BODY_COLOR_BROWN,
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_SKIDDO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_CHLOROPHYLL, ABILITY_MOUNTAINEER },
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_ESPURR] =
    {
        ...
        .innateAbility = ABILITY_OWN_TEMPO,
    ...
    [SPECIES_MEOWSTIC_M] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_INFILTRATOR, ABILITY_PSYCHIC_SURGE },
    ...
    [SPECIES_MEOWSTIC_F] =
    {
        ...
        .innateAbility = ABILITY_PRANKSTER,
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Meowstic"),
        .cryId = CRY_MEOWSTIC,
        .natDexNum = NATIONAL_DEX_MEOWSTIC,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SPRITZEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_HEALER, ABILITY_NONE, ABILITY_PIXILATE },
        .innateAbility = ABILITY_AROMA_VEIL,
    ...
    [SPECIES_SWIRLIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_WELL_BAKED_BODY, ABILITY_NONE, ABILITY_UNBURDEN },
        .innateAbility = ABILITY_SWEET_VEIL,
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_MALAMAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_2),
        .abilities = { ABILITY_CONTRARY, ABILITY_TINTED_LENS, ABILITY_INFILTRATOR },
        .innateAbility = ABILITY_PSYCHIC_MIND,
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MALAMAR_MEGA] = //100 + BST.
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_2),
        .abilities = { ABILITY_CONTRARY, ABILITY_TINTED_LENS, ABILITY_TINTED_LENS },
        .innateAbility = ABILITY_FULL_BLOWN_MIND_POWER,
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Malamar"),
        .cryId = CRY_MALAMAR,
        .natDexNum = NATIONAL_DEX_MALAMAR,
    ...
    [SPECIES_SKRELP] =
    {
        ...
        .abilities = { ABILITY_CORROSION, ABILITY_POISON_TOUCH, ABILITY_ADAPTABILITY },
        .innateAbility = ABILITY_PROPELLER_TAIL,
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_AMAURA] =
    {
        ...
        .abilities = { ABILITY_REFRIGERATE, ABILITY_NONE, ABILITY_SOLID_ROCK },
        .innateAbility = ABILITY_FOSSILIZED,
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_HAWLUCHA] =
    {
        ...
        .innateAbility = ABILITY_NO_GUARD,
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_DEDENNE] =
    {
        ...
        .abilities = { ABILITY_CHEEK_POUCH, ABILITY_POWER_SPOT, ABILITY_REGENERATOR },
        .innateAbility = ABILITY_SHORT_CIRCUIT,
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CARBINK] =
    {
        ...
        .innateAbility = ABILITY_POWER_SPOT,
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_SLIGGOO_HISUI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_SHELL_ARMOR, ABILITY_BULLETPROOF },
        .innateAbility = ABILITY_GOOEY,
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Sliggoo"),
        .cryId = CRY_SLIGGOO,
    ...
    [SPECIES_TREVENANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_FRISK, ABILITY_HARVEST },
        .innateAbility = ABILITY_CURSED_BODY,
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PUMPKABOO_AVERAGE] =
    {
        ...
        .abilities = { ABILITY_FLARE_BOOST, ABILITY_FRISK, ABILITY_INSOMNIA },
        .innateAbility = ABILITY_PICKUP,
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 40,
        .types = MON_TYPES(TYPE_SOUND, TYPE_DRAGON),
        .catchRate = 190,
        .expYield = 49,
        .evYield_Speed = 1,
        .genderRatio = PERCENT_FEMALE(50),
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
    #endif
        .abilities = { ABILITY_FRISK, ABILITY_NOCTURNAL, ABILITY_TELEPATHY },
    ...
    [SPECIES_NOIVERN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
    #endif
        .abilities = { ABILITY_FRISK, ABILITY_NOCTURNAL, ABILITY_PUNK_ROCK },
        .innateAbility = ABILITY_INFILTRATOR,
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_ZYGARDE_50] =
    {
        ...
        .innateAbility = ABILITY_POWER_CONSTRUCT,
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_DIANCIE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MAGIC_GUARD, ABILITY_NONE, ABILITY_SOLID_ROCK },
        .innateAbility = ABILITY_CLEAR_BODY,
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_HOOPA_CONFINED] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MAGICIAN, ABILITY_NONE, ABILITY_ILLUSION },
        .innateAbility = ABILITY_PRANKSTER,
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Hoopa"),
    ...
    [SPECIES_HOOPA_UNBOUND] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MAGICIAN, ABILITY_NONE, ABILITY_INTIMIDATE },
        .innateAbility = ABILITY_LONG_REACH,
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Hoopa"),
    ...
    [SPECIES_VOLCANION] =
    {
        ...
        .innateAbility = ABILITY_MEGA_LAUNCHER,
        .bodyColor = BODY_COLOR_BROWN,
