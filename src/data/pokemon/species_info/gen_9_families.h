...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_FUECOCO] =
    {
        ...
        .abilities = { ABILITY_RATTLED, ABILITY_NONE, ABILITY_UNAWARE },
    ...
    [SPECIES_NACLI] =
    {
        ...
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_STURDY, ABILITY_LOOSE_ROCKS },
        //.innateAbility = ABILITY_PURIFYING_SALT,
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Nacli"),
        .cryId = CRY_NACLI,
    ...
    [SPECIES_ARMAROUGE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_WEAK_ARMOR, ABILITY_NONE, ABILITY_MEGA_LAUNCHER },
