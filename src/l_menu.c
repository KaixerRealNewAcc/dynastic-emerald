...
static const u8 gText_MenuPokeVial[] = _("POKé Vial");
static const u8 gText_MenuPokeVial2[] = _("NUZVAIL");
//static const u8 gText_MenuDexNav[] = _("DexNav");
static const u8 gText_TimeChanger[] = _("TIME");
...
static void BuildNormalLMenu(void)
{
    bool8 hasDexNav = DN_FLAG_DEXNAV_GET != 0 && FlagGet(DN_FLAG_DEXNAV_GET);
