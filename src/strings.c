...
const u8 *const gPocketNamesStringsTable[] =
{
    ...
    [POCKET_MEGA_STONES] =  COMPOUND_STRING("{COLOR WHITE}{SHADOW DARK_GRAY}Mega Stones"),
...
const u8 gText_ChoosePokemon[] = _("");
...
const u8 gText_HealthboxNicknameOld[] = _("{HIGHLIGHT DARK_GRAY}"); // Unused
