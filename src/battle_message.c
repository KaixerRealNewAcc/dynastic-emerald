...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_ITDOESNTAFFECT]                        = COMPOUND_STRING("It doesn't affect {B_DEF_NAME_WITH_PREFIX2}…"), //not in gen 5+, ability popup
    [STRINGID_SCR_ITDOESNTAFFECT]                       = COMPOUND_STRING("It doesn't affect {B_DEF_NAME_WITH_PREFIX2}…"),
