...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNSXHADNOEFFECTONY]                 = COMPOUND_STRING("Target protected by ability!"), //not in gen 5+, ability popup
    ...
    [STRINGID_FOREWARNACTIVATES]                    = COMPOUND_STRING("ability alerted {B_SCR_NAME_WITH_PREFIX2} to {B_DEF_NAME_WITH_PREFIX2}'s {B_BUFF1}!"),
    ...
    [STRINGID_ABILITYRAISEDSTATDRASTICALLY]         = COMPOUND_STRING("ability raised {B_DEF_NAME_WITH_PREFIX2}'s {B_BUFF1} drastically!"),
    ...
    [STRINGID_ABILITYALLOWSONLYMOVE]                = COMPOUND_STRING("ability only allows the use of {B_CURRENT_MOVE}!\p"),
