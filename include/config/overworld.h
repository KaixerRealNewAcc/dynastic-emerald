...
#define OW_FLAG_NO_ENCOUNTER        FLAG_UNUSED_0x021  // If this flag is set, wild encounters will be disabled.
...
// Variable Rod
#define OW_VAR_VARIABLE_ROD_USE_TECHNIQUE       VAR_RODS     // If this var has a value, the game will use it to remember the used fishing technique.
#define OW_FLAG_VARIABLE_ROD_GOOD_TECHNIQUE     FLAG_FISHING_1     // If this flag is set, the game will unlock the 'good fishing technique'.
#define OW_FLAG_VARIABLE_ROD_SUPER_TECHNIQUE    FLAG_FISHING_2     // If this flag is set, the game will unlock the 'super fishing technique'.
