...
#define END_OF_NORMAL_SPECIES                           SPECIES_MIMIKYU_BUSTED_TOTEM
#define START_OF_ZA_MEGAS                               END_OF_NORMAL_SPECIES

#define SPECIES_CLEFABLE_MEGA                           (START_OF_ZA_MEGAS + 1)
#define SPECIES_VICTREEBEL_MEGA                         (START_OF_ZA_MEGAS + 2)
#define SPECIES_STARMIE_MEGA                            (START_OF_ZA_MEGAS + 3)
#define SPECIES_DRAGONITE_MEGA                          (START_OF_ZA_MEGAS + 4)
#define SPECIES_MEGANIUM_MEGA                           (START_OF_ZA_MEGAS + 5)
#define SPECIES_FERALIGATR_MEGA                         (START_OF_ZA_MEGAS + 6)
#define SPECIES_SKARMORY_MEGA                           (START_OF_ZA_MEGAS + 7)
#define SPECIES_FROSLASS_MEGA                           (START_OF_ZA_MEGAS + 8)
#define SPECIES_EMBOAR_MEGA                             (START_OF_ZA_MEGAS + 9)
#define SPECIES_EXCADRILL_MEGA                          (START_OF_ZA_MEGAS + 10)
#define SPECIES_SCOLIPEDE_MEGA                          (START_OF_ZA_MEGAS + 11)
#define SPECIES_SCRAFTY_MEGA                            (START_OF_ZA_MEGAS + 12)
#define SPECIES_EELEKTROSS_MEGA                         (START_OF_ZA_MEGAS + 13)
#define SPECIES_CHANDELURE_MEGA                         (START_OF_ZA_MEGAS + 14)
#define SPECIES_CHESNAUGHT_MEGA                         (START_OF_ZA_MEGAS + 15)
#define SPECIES_DELPHOX_MEGA                            (START_OF_ZA_MEGAS + 16)
#define SPECIES_GRENINJA_MEGA                           (START_OF_ZA_MEGAS + 17)
#define SPECIES_PYROAR_MEGA                             (START_OF_ZA_MEGAS + 18)
#define SPECIES_MALAMAR_MEGA                            (START_OF_ZA_MEGAS + 19)
#define SPECIES_DRAGALGE_MEGA                           (START_OF_ZA_MEGAS + 20)
#define SPECIES_HAWLUCHA_MEGA                           (START_OF_ZA_MEGAS + 21)
#define SPECIES_FLOETTE_MEGA                            (START_OF_ZA_MEGAS + 22)
#define SPECIES_BARBARACLE_MEGA                         (START_OF_ZA_MEGAS + 23)
#define SPECIES_ZYGARDE_MEGA                            (START_OF_ZA_MEGAS + 24)
#define SPECIES_DRAMPA_MEGA                             (START_OF_ZA_MEGAS + 25)
#define SPECIES_FALINKS_MEGA                            (START_OF_ZA_MEGAS + 26)

//DLC
#define SPECIES_HEATRAN_MEGA                            (START_OF_ZA_MEGAS + 27)
#define SPECIES_DARKRAI_MEGA                            (START_OF_ZA_MEGAS + 28)
#define SPECIES_ZERAORA_MEGA                            (START_OF_ZA_MEGAS + 29)
#define SPECIES_RAICHU_MEGA_X                           (START_OF_ZA_MEGAS + 30)
#define SPECIES_RAICHU_MEGA_Y                           (START_OF_ZA_MEGAS + 31)
#define SPECIES_CHIMECHO_MEGA                           (START_OF_ZA_MEGAS + 32)
#define SPECIES_ABSOL_MEGA_Z                            (START_OF_ZA_MEGAS + 33)
#define SPECIES_STARAPTOR_MEGA                          (START_OF_ZA_MEGAS + 34)
#define SPECIES_GARCHOMP_MEGA_Z                         (START_OF_ZA_MEGAS + 35)
#define SPECIES_LUCARIO_MEGA_Z                          (START_OF_ZA_MEGAS + 36)
#define SPECIES_GOLURK_MEGA                             (START_OF_ZA_MEGAS + 37)
#define SPECIES_MEOWSTIC_MEGA                           (START_OF_ZA_MEGAS + 38)
#define SPECIES_CRABOMINABLE_MEGA                       (START_OF_ZA_MEGAS + 39)
#define SPECIES_GOLISOPOD_MEGA                          (START_OF_ZA_MEGAS + 40)
#define SPECIES_MAGEARNA_MEGA                           (START_OF_ZA_MEGAS + 41)
#define SPECIES_MAGEARNA_ORIGINAL_MEGA                  (START_OF_ZA_MEGAS + 42)
#define SPECIES_SCOVILLAIN_MEGA                         (START_OF_ZA_MEGAS + 43)
#define SPECIES_BAXCALIBUR_MEGA                         (START_OF_ZA_MEGAS + 44)
#define SPECIES_TATSUGIRI_MEGA                          (START_OF_ZA_MEGAS + 45)
#define SPECIES_GLIMMORA_MEGA                           (START_OF_ZA_MEGAS + 46)

#define END_OF_ZA_MEGAS                                 SPECIES_GLIMMORA_MEGA                         
#define START_OF_CUSTOM_MEGAS                           END_OF_ZA_MEGAS      

#define SPECIES_COALOSSAL_MEGA                          (START_OF_CUSTOM_MEGAS + 1)
#define SPECIES_ARCEUS_SOUND                            (START_OF_CUSTOM_MEGAS + 2)
#define SPECIES_SILVALLY_SOUND                          (START_OF_CUSTOM_MEGAS + 3)
#define SPECIES_NIDOKING_MEGA                           (START_OF_CUSTOM_MEGAS + 4)
#define SPECIES_NIDOQUEEN_MEGA                          (START_OF_CUSTOM_MEGAS + 5)
