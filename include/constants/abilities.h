...
#define ABILITY_WEAK_JAW            (ABILITIES_COUNT_GEN9 + 1)
#define ABILITY_SHORT_CIRCUIT       (ABILITIES_COUNT_GEN9 + 2)
#define ABILITY_FREEZING_MELODY     (ABILITIES_COUNT_GEN9 + 3)
#define ABILITY_MEAN_GLARE          (ABILITIES_COUNT_GEN9 + 4)
#define ABILITY_MOUNTAINEER         (ABILITIES_COUNT_GEN9 + 5)
#define ABILITY_WEATHER_CONTROL     (ABILITIES_COUNT_GEN9 + 6)
#define ABILITY_STRIKER             (ABILITIES_COUNT_GEN9 + 7)
#define ABILITY_SPIKY_THORNS        (ABILITIES_COUNT_GEN9 + 8)
#define ABILITY_PHANTOM_PAIN        (ABILITIES_COUNT_GEN9 + 9)
#define ABILITY_GRAVITATIONAL_PULL  (ABILITIES_COUNT_GEN9 + 10) //Palkia's (both) ability.
#define ABILITY_FLAMING_JAWS        (ABILITIES_COUNT_GEN9 + 11)
#define ABILITY_FORESTS_RAGE        (ABILITIES_COUNT_GEN9 + 12)
#define ABILITY_HELLBLAZE           (ABILITIES_COUNT_GEN9 + 13)
#define ABILITY_TIDAL_WRATH         (ABILITIES_COUNT_GEN9 + 14) 
#define ABILITY_EARTHBOUND          (ABILITIES_COUNT_GEN9 + 15) 
#define ABILITY_ELECTRIFIED_VEINS   (ABILITIES_COUNT_GEN9 + 16)
#define ABILITY_NOCTURNAL           (ABILITIES_COUNT_GEN9 + 17)
#define ABILITY_AIR_BLOWER          (ABILITIES_COUNT_GEN9 + 18) //Giratina's (both) ability.
#define ABILITY_TWISTED_DIMENSION   (ABILITIES_COUNT_GEN9 + 20) //Dialgia's (both) ability.
#define ABILITY_SIGHTING_SYSTEM     (ABILITIES_COUNT_GEN9 + 21)
#define ABILITY_FOSSILIZED          (ABILITIES_COUNT_GEN9 + 22)
#define ABILITY_FATAL_PRECISION     (ABILITIES_COUNT_GEN9 + 23)
#define ABILITY_MIGHTY_TUSKS        (ABILITIES_COUNT_GEN9 + 24)
#define ABILITY_THICK_SACK          (ABILITIES_COUNT_GEN9 + 25) //New Thick Fat, also used by Delibird.
#define ABILITY_FIELD_EXPLORER      (ABILITIES_COUNT_GEN9 + 26)
#define ABILITY_FLOCK               (ABILITIES_COUNT_GEN9 + 27) 
#define ABILITY_FELINE_PROWESS      (ABILITIES_COUNT_GEN9 + 28)
#define ABILITY_ERUPTIVE_BACK       (ABILITIES_COUNT_GEN9 + 29)
#define ABILITY_PSYCHIC_MIND        (ABILITIES_COUNT_GEN9 + 30)
#define ABILITY_SAND_SONG           (ABILITIES_COUNT_GEN9 + 31)
#define ABILITY_HYPER_AGGRESIVE     (ABILITIES_COUNT_GEN9 + 32)
#define ABILITY_PURE_LOVE           (ABILITIES_COUNT_GEN9 + 33)
#define ABILITY_IMPENETRABLE        (ABILITIES_COUNT_GEN9 + 34) //KAIDO: FINISH ANOTHER TIME.
#define ABILITY_JETSTREAM           (ABILITIES_COUNT_GEN9 + 35)
#define ABILITY_FIGHTING_SPIRIT     (ABILITIES_COUNT_GEN9 + 36)
#define ABILITY_LOOSE_ROCKS         (ABILITIES_COUNT_GEN9 + 37)
#define ABILITY_WEB_SPINNER         (ABILITIES_COUNT_GEN9 + 38)
#define ABILITY_FULL_BLOWN_MIND_POWER (ABILITIES_COUNT_GEN9 + 39)
#define ABILITY_PRIMAL_ARMOR        (ABILITIES_COUNT_GEN9 + 40)
#define ABILITY_LOOSE_QUILLS        (ABILITIES_COUNT_GEN9 + 41)
#define ABILITY_FIGHTER             (ABILITIES_COUNT_GEN9 + 42)
#define ABILITY_ADRENALINE_RUSH     (ABILITIES_COUNT_GEN9 + 43)
...
#define ABILITIES_COUNT_CUSTOM      (ABILITIES_COUNT_GEN9 + 80)
