...
#define AI_FLAG_SMART_TRAINER_DEFINES (AI_FLAG_BASIC_TRAINER | AI_FLAG_OMNISCIENT | AI_FLAG_SMART_SWITCHING | AI_FLAG_SMART_MON_CHOICES | AI_FLAG_PP_STALL_PREVENTION | AI_FLAG_PREDICTION | AI_FLAG_RANDOMIZE_SWITCHIN)
#define AI_FLAG_SEMI_SMART_TRAINER_DEFINES (AI_FLAG_BASIC_TRAINER | AI_FLAG_OMNISCIENT | AI_FLAG_SMART_MON_CHOICES | AI_FLAG_PREDICTION )

//Used by every "Boss" & "Expert" Trainers
#define AI_FLAG_SMART_TRAINER         (AI_FLAG_SMART_TRAINER_DEFINES)

#define AI_FLAG_SEMI_SMART_TRAINER    (AI_FLAG_SEMI_SMART_TRAINER_DEFINES)
