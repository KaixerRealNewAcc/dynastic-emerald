...
enum StringID
{
    ...
    STRINGID_PLAYERWHITEOUTNUZLOCK,
    ...
    STRINGID_PKMNMADEGRAVITYTURNUPSIDEDOWN,
    STRINGID_UNNERVEENTERS,
    STRINGID_ABILITYSHIELDPROTECTS,
    STRINGID_BATTLERADDEDTHETYPE,
    STRINGID_PKMNMADETHEFIELDTWISTED,
    STRINGID_LOOSEROCKSSCATTERED,
    STRINGID_USERSPUNAWEB,
    STRINGID_LOOSESQUILSSCATTERED,
    STRINGID_FETCHEDPOKEBALL2,
    STRINGID_ELECTROBOOSTERENTERS,
    STRINGID_COUNT
};
...
enum SwitchInAbilityStringID
{
    ...
    B_MSG_SWITCHIN_ELECTRO_BOOSTER,
};
