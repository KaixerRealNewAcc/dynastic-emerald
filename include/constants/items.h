...
#define ITEM_COALOSSITE     (ITEM_STRANGE_BALL + 2)
#define ITEM_VARIABLE_ROD   (ITEM_STRANGE_BALL + 3)
#define ITEM_ECHO_PLATE     (ITEM_STRANGE_BALL + 4)
#define ITEM_INF_REPEL      (ITEM_STRANGE_BALL + 5)
#define ITEM_NIDOKINGITE    (ITEM_STRANGE_BALL + 6)
#define ITEM_NIDOQUEENITE   (ITEM_STRANGE_BALL + 7)
#define ITEM_INFINITE_CANDY (ITEM_STRANGE_BALL + 8)

// HOPO BERRY
// LEGEND PLATE

#define ITEMS_COUNT (ITEM_STRANGE_BALL + 9)
